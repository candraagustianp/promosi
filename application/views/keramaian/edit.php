<div class="mt-3">
    <form method="post" action="<?= site_url("Keramaian/update/".$data['id']) ?>">
    <div class="form-group">
        <label for="nama">Nama Tempat</label>
        <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukan Nama Pusat Keramaian" value="<?= $data['nama'] ?>" >
    </div>
    <div class="form-group">
