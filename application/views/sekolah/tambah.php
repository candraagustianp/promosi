<div class="mt-3">
    <form method="post" action="<?= site_url("Sekolah/save") ?>">
    <div class="form-group">
        <label for="nama">Nama Sekolah</label>
        <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukan Nama Sekolah">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" name="potensi" id="potensi" placeholder="Masukan Angka">
    </div>
    <div class="form-group">
